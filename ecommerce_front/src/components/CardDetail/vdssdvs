...
const CardDetail = () => {
  ...
  const availabilityClass = game.active
    ? style.availableGreen
    : style.availableRed;
      ...
      {game && (
        <>
          ...
          <div className={style.containerGame2}>
            ...
            <p className={style.available + " " + availabilityClass}>
              available
            </p>
          ...
          <div className={style.containerGame4}>
            ...
            <div className={style.etc}>
              ...
              {game.Designers.map((designer) => (
                <p key={designer.designer_id} className={style.designers}>
                  {designer.designer_name}
                </p>
              ))}
              <p className={style.editorial}>Editorial</p>
              <p className={style.editorials}>
                {game.Editorial.editorial_name}
              </p>
              ...
              {game.Languages.map((language) => (
                <p key={language.language_id} className={style.languages}>
                  {language.language_name}
                </p>
              ))}
            </div>
          </div>
          {/* <div className={style.imgMini}></div> */}
