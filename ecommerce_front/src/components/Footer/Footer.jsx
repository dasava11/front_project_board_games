    ...
    <footer className={style.footerContainer}>
      <div className={style.upFooter}>
        <div className={style.footerSocial}>
          <h1>Follow Us</h1>
          <a href="https://www.instagram.com/hpartb/" target="_blank" rel="noopener noreferrer">
            <img src={Instagram} alt="Instagram Logo" />
          </a>
          <a href="https://www.facebook.com/profile.php?id=100094509813076" target="_blank" rel="noopener noreferrer">
        ...
        <div className={style.footerInput}>
          ...
          <button onClick={handleSubscribe} className={style.buttomFooter}>Subscribe</button>
        </div>
      </div>
